...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Registrasi Kode Jenis Barang</h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                ?>
                                &nbsp;
                                <a href="exportkodejenis.php" class="btn btn-info"> Export Data </a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                              $data=mysqli_query($conn, "SELECT * FROM kode_jenis");
                                              $i= 1;
                                              while($stock = mysqli_fetch_array($data)){
                                                $idkodes=$stock['idaj'];
                                                $kodebarang=$stock['idjenis'];
                                                $jenisbarang=$stock['nama_jenis'];
                                            ?>
	                                          <td><?php echo $i++; ?></td>
                                              <td><?php echo $stock['idjenis']; ?></td>
                                              <td><?php echo $stock['nama_jenis']; ?></td>
                                              <?php
                                              $admin = "Admin";
                                              if( $_SESSION['level'] == $admin ){?>
                                              <?php }else{?>
                                             <td>
                                                &nbsp;&nbsp;&nbsp;
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$idkodes;?>">
                                                        Edit
                                                </button>
                                            &nbsp;&nbsp;&nbsp
                                               <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idkodes;?>">
                                                        Delete
                                                </button>
                                              </td>
                                              <?php }?>
                                              ...
                                              <div class="modal fade" id="edit<?=$idkodes;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    ...
                                                    <form method="post" action="function.php">
                                                        <div class="modal-body">
                                                            ...
                                                            <Input type="text" name="jenis" value="<?=$jenisbarang;?>" class="form-control" required="required">
                                                            <Input type="hidden" name="idkode" value="<?=$idkodes;?>">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-primary" name="updatejenis">Update</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                </div>
                                                ...
                                                <div class="modal fade" id="delete<?=$idkodes;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form method="post" action="function.php">
                                                        <div class="modal-body">
                                                            Apakah anda yakin ingin menghapus <?=$kodebarang?>,<?=$jenisbarang?> ?
                                                            <input type="hidden" name="idkode" value="<?=$idkodes;?>">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-danger" name="hapusjenis">Delete</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Registrasi Kode Jenis Barang</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="post" action="function.php">
                <div class="modal-body">
