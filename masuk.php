                                            ...
                                            ?>
                                              ...
                                              <div class="modal fade" id="edit<?=$idm;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <form method="post" action="function.php">
                                                        <div class="modal-body">
                                                            Apakah anda yakin ingin menghapus <?=$kodebarang?>, <?=$namabarang?> dengan jumlah <?=$stok?> ?
                                                            <input type="hidden" name="idkb" value="<?=$idkb;?>">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-danger" name="hapusmasuk">Delete</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                </div>
        ...
        <div class="modal-dialog">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <br>
                    <label>Keadaan</label>
                    <select name="keadaan" class="form-control" required="required">
